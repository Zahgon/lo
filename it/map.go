...
func Keys[K comparable, V any](in ...map[K]V) iter.Seq[K] { _ = "STUB: not implemented"; return nil }
...
func Values[K comparable, V any](in ...map[K]V) iter.Seq[V] { _ = "STUB: not implemented"; return nil }
...
func UniqValues[K, V comparable](in ...map[K]V) iter.Seq[V] { _ = "STUB: not implemented"; return nil }
...
func Seq2KeyToSeq[K, V any](in iter.Seq2[K, V]) iter.Seq[K] { _ = "STUB: not implemented"; return nil }
