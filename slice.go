...
func Repeat[T Clonable[T]](count int, initial T) []T { _ = "STUB: not implemented"; return nil }
...
func Count[T comparable](collection []T, value T) int { _ = "STUB: not implemented"; return 0 }
...
func CountValues[T comparable](collection []T) map[T]int { _ = "STUB: not implemented"; return nil }
...
func IsSorted[T constraints.Ordered](collection []T) bool { _ = "STUB: not implemented"; return false }
...
// preallocate memory for the output slice
...
func Cut[T comparable, Slice ~[]T](collection, separator Slice) (before, after Slice, found bool) {
	_ = "STUB: not implemented"
	return *new(Slice), *new(Slice), false
}
